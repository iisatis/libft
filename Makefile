...
#    Updated: 2021/01/09 14:53:36 by pflorent         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS	= ft_atoi.c ft_bzero.c ft_calloc.c ft_is.c ft_itoa.c ft_memccpy.c \
		ft_memchr.c ft_memcmp.c ft_memcpy.c ft_memmove.c ft_memset.c ft_put_fd.c \
		...
		ft_strrchr.c ft_strtrim.c ft_substr.c ft_to.c
